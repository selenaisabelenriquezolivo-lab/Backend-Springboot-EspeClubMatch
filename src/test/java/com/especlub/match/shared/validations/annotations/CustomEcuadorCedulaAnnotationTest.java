...
class CustomEcuadorCedulaAnnotationTest {
    @Test
    void testAnnotationTargets() {
        Target target = CustomEcuadorCedula.class.getAnnotation(Target.class);
    ...
    void testAnnotationRetention() {
        Retention retention = CustomEcuadorCedula.class.getAnnotation(Retention.class);
    ...
    void testAnnotationDocumented() {
        assertTrue(CustomEcuadorCedula.class.isAnnotationPresent(Documented.class), "Debe estar documentada");
    }

    @Test
    void testDefaultMessage() throws NoSuchMethodException {
        Method messageMethod = CustomEcuadorCedula.class.getMethod("message");
        assertEquals("Cédula de identidad ecuatoriana inválida", messageMethod.getDefaultValue(), "El mensaje por defecto debe ser el esperado");
    }
}
